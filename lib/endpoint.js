...
// 1. POST /api/project/budget/currency - Find budget details with currency conversion
endpoints.post('/api/project/budget/currency', async (req, res) => {
  try {
...
// 2. GET /api/project/budget/:id - Get project by ID
endpoints.get('/api/project/budget/:id', async (req, res) => {
...
// 3. POST /api/project/budget - Create new project
endpoints.post('/api/project/budget', async (req, res) => {
  try {
...
// 4. PUT /api/project/budget/:id - Update project
endpoints.put('/api/project/budget/:id', async (req, res) => {
  try {
    const projectId = parseInt(req.params.id)
...
// 5. DELETE /api/project/budget/:id - Delete project
endpoints.delete('/api/project/budget/:id', async (req, res) => {
  try {
    const projectId = parseInt(req.params.id)
